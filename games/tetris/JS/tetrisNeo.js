...
function drawPause() {
  ...
  context.fillRect(
    canvas.height / 100 - 2.9,
    canvas.width / 100 + 7.2,
    10,
    0.85
  );
  ...
  context.fillText(
    "кто двинется тот [ДАННЫЕ УДАЛЕНЫ]",
    canvas.height / 100 - 2.9,
    canvas.width / 100 + 7.5
  );
}
